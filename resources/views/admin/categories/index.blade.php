...
@section('content')
    <section class="container-fluid" id="festivalTableContainer">
        <form action="{{route('admin.categories.index')}}" method="GET" id="filter_form"></form>
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <a class="btn btn-primary" href="{{route('admin.categories.create')}}"><i class="fas fa-plus-square"></i> Create</a>
                    <div class="search-form d-flex">
                        <input placeholder="Category Names" name="search[name]" type="search" class="form-control">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <a class="dropdown-item" href="{{route('admin.categories.edit', ['category' => $item->id])}}">Edit</a>
                                                    ...
                                                    <form method="POST" id="delete_action{{$item->id}}" action="{{route('admin.categories.destroy', ['category' => $item])}}">
                                                        @csrf
                                                        @method('delete')
                                                    </form>
                                                </div>
